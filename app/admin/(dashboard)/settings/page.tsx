...
import { Save, Globe, Phone, Mail, Facebook, Instagram, Twitter, Linkedin } from "lucide-react";
...
export default async function AdminSettingsPage() {
    ...
    return (
        <div className="max-w-4xl space-y-8">
            ...
            <form action={updateSettings} className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-8">
                    <Card className="border-none shadow-sm">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-2 pt-4 border-t border-slate-50">
                                ...
                                <Input name="metaPixelId" defaultValue={settings?.metaPixelId || ""} placeholder="e.g. 1234567890" />
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input name="facebook" defaultValue={settings?.facebook || ""} placeholder="https://..." />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input name="instagram" defaultValue={settings?.instagram || ""} placeholder="https://..." />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input name="twitter" defaultValue={settings?.twitter || ""} placeholder="https://..." />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input name="linkedin" defaultValue={settings?.linkedin || ""} placeholder="https://..." />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="flex justify-end">
                        <Button type="submit" size="lg" className="px-12 font-bold shadow-lg shadow-primary/20">
